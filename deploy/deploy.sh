...
AI_SAFETY_REQUIRED_FILES=(
    ...
    "app/common/service/AiBoundaryService.php"
    "app/common/service/RagRetriever.php"
    "app/common/service/KnowledgeChunker.php"
    "app/adm/controller/AiKnowledge.php"
    "app/adm/controller/AiSafety.php"
    "app/command/AiSafetyClean.php"
    "app/command/AiRagEval.php"
    "config/console.php"
    "config/ai_safety.php"
    "view/adm/ai_knowledge/index.html"
    "view/adm/ai_knowledge/add.html"
    "view/adm/ai_knowledge/edit.html"
    ...
    "database/patch_20260707_ai_boundary_trace_rag_eval.sql"
    "database/rag_eval_cases.json"
)
log() {
    printf '[deploy] %s\n' "$*"
}
