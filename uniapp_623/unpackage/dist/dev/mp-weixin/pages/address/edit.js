...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o((...args) => $options.getWxAddress && $options.getWxAddress(...args), "04"),
    b: common_vendor.o((...args) => $options.getFromValue && $options.getFromValue(...args), "d8"),
    c: $data.form.name,
    d: common_vendor.o(($event) => $data.form.name = $event.detail.value, "41"),
    e: common_vendor.o((...args) => $options.getFromValue && $options.getFromValue(...args), "a7"),
    f: $data.form.phone,
    g: common_vendor.o(($event) => $data.form.phone = $event.detail.value, "45"),
    h: $data.region,
    i: common_vendor.o(($event) => $data.region = $event.detail.value, "9f"),
    j: common_vendor.o((...args) => $options.selectAddress && $options.selectAddress(...args), "97"),
    k: common_vendor.o((...args) => $options.getFromValue && $options.getFromValue(...args), "7f"),
    l: $data.form.detail,
    m: common_vendor.o(($event) => $data.form.detail = $event.detail.value, "fc"),
    n: $data.form.isDefault,
    o: common_vendor.o((...args) => $options.toggleDefault && $options.toggleDefault(...args), "c9"),
    p: common_vendor.o((...args) => $options.saveAddress && $options.saveAddress(...args), "5d"),
    q: !$data.isSave ? 1 : "",
    r: common_vendor.o($options.confirm, "7c"),
    s: common_vendor.o($options.cancel, "c3"),
    t: common_vendor.p({
      column: $data.column,
