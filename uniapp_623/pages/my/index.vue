	...
	<view class="profile">
		...
		<view class="user-info" @click="goToProfile()">
			...
			<view class="user-details">
				...
				<view class="user-id">GooMoo ID: {{ userInfo.id }}</view>
			</view>
		</view>
			...
			<view class="order-status">
				<view class="status-item" @click="goToOrders(1)">
					<view class="status-icon">
						<image class="nav-item-image" src="/static/image/icon_pending.png" mode="widthFix"></image>
					</view>
					<text class="status-text">待支付</text>
				</view>
				<view class="status-item" @click="goToOrders(8)">
					<view class="status-icon">
						<image class="nav-item-image" src="/static/image/icon_booked.png" mode="widthFix"></image>
					</view>
					<text class="status-text">已预定</text>
				</view>
				<view class="status-item" @click="goToOrders(2)">
					<view class="status-icon">
						<image class="nav-item-image" src="/static/image/icon_shipped.png" mode="widthFix"></image>
					</view>
					<text class="status-text">待发货</text>
				</view>
				<view class="status-item" @click="goToOrders(6)">
					<view class="status-icon">
						<image class="nav-item-image" src="/static/image/icon_received.png" mode="widthFix"></image>
					</view>
					<text class="status-text">待收货</text>
				</view>
				<view class="status-item" @click="goToOrders(7)">
					<view class="status-icon">
						<image class="nav-item-image" src="/static/image/icon_completed.png" mode="widthFix"></image>
					</view>
			...
			<view class="function-list">
				<view class="function-item" @click="goToCart()">
					<view class="function-icon">
						<image class="nav-item-image" src="/static/image/icon_cart.png" mode="widthFix"></image>
					</view>
				...
				<view class="function-item" @click="goToProfile()">
					<view class="function-icon">
						<image class="nav-item-image" src="/static/image/icon_profile.png" mode="widthFix"></image>
					</view>
				...
				<view class="function-item" @click="goToCustomer()">
					<view class="function-icon">
						<image class="nav-item-image" src="/static/image/icon_service.png" mode="widthFix"></image>
					</view>
				...
				<view class="function-item" @click="goToAfterSales()">
					<view class="function-icon">
						<image class="nav-item-image" src="/static/image/icon_question.png" mode="widthFix"></image>
					</view>
				...
				<view class="function-item" @click="goToAgreement()">
					<view class="function-icon">
						<image class="nav-item-image" src="/static/image/icon_document.png" mode="widthFix"></image>
					</view>
